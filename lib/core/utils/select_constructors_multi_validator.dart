...
class MultiSelectDropdownValidator extends StatefulWidget {
  ...
  final String? Function(List<DropdownItem>?)? validator; // إضافة الـ validator

  const MultiSelectDropdownValidator({
    Key? key,
    required this.items,
  ...
  @override
  _MultiSelectDropdownValidatorState createState() =>
      _MultiSelectDropdownValidatorState();
}

class _MultiSelectDropdownValidatorState
    extends State<MultiSelectDropdownValidator> {
              ...
              : () {
                  setState(() {
                    ...
                    if (widget.validator != null) {
                      errorMessage = widget.validator!(selectedValues);
                    }
                  });
                },
          child: Container(
